 ...
 *
 * @property int $id
 * @property string|null $provider Oauth 공급사
 * @property string|null $provider_user_id Oauth 로그인 ID
...
class User extends Authenticatable
{
    ...
    use HasApiTokens, HasFactory, Notifiable, SoftDeletes, \Illuminate\Auth\Authenticatable;
